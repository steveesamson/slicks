...
var Collection = null,
    ...
    createView = function (model) {
        return View({
            ...
            template: "@<li>{name} - {age} <a href='#' class='detail'>detail</a> | <a href='#' class='delete'>delete</a></li>",
            host: '.lists',
            events: {
...
describe('#Slicks ', function () {
    ...
    describe('@Model', function () {
        ...
        describe(' >set', function () {
            ...
            it('Should return name = tom after set', function () {
                userModel.set({name: 'tom', gender: 'male', age: 30});
                userModel.get('name').should.equal('tom');
            });

            it('Should return ender=male after set', function () {
                userModel.set({name: 'tom', gender: 'male', age: 30});
                userModel.get('gender').should.equal('male');
            });

            it('Should return  age=30 after set', function () {
                userModel.set({name: 'tom', gender: 'male', age: 30});
        ...
        describe(' >post, >get, >success, >error', function () {
    ...
    describe('@Collection', function () {
        ...
        describe(' >create', function () {
            ...
            it('Should return length 6 after creating 2 more models', function () {
                ...
                users.create({name: 'matha', age: 75}, function (e,m) {

                    users.create({name: 'phil', age: 33}, function (e, m) {
        ...
        describe(' >add', function () {
            ...
            it('Expect collection length to be 5', function () {
    ...
    describe('@View', function () {
        ...
        describe(" >View Creation and check options", function () {
        ...
        describe(' >Events', function(){
            ...
            it("Expects listItemView.$host.find('li').size() to be equal to 3", function () {
                ...
                //console.log(listItemView.$host.html());
